...
<%@ taglib uri="http://www.springframework.org/tags" prefix="spring"%>
	                ...
	                <div class="standard-box">
	                    <h1 class="standard-header">
	                  	...
	                  	<div class="row">
							...
							<form class="form-horizontal form-register" role="form" id="logonForm" name="logonForm">
	                            <h2 class="text-center no-margin">로그인</h2>
	                            <div class="row">
	                                    ...
	                                    <ul class="list-inline text-center">
	                                        <li>
	                                           <span class="btn-group">
						                            <a href="#onclick" class="btn btn-lg btn-danger list-view active" onclick="lfn_logon()">로그인</a>
						                        </span>
	                                        </li>
	                                    </ul>
	                                </div>
		                        ...
		                        <div class="form-group">
	                                <div class="col-sm-offset-4 col-sm-5">
	                                    <ul class="list-inline text-center">
	                                        <li>
	                                           <span class="btn-group">
						                            <a href="/member/idPassword.do" class="btn btn-lg btn-danger tiles-view">아이디/비밀번호 찾기 <i class="fa fa-arrow-right"></i></a>
						                        </span>
	                                        </li>
	                                    </ul>
	                                 </div>
	...
	this.lfn_logon = function()
	{
		if(!lfn_preSearch()) return;
		
		var param = $("form[name=logonForm]").serialize();
		var lo_coreJson =gfn_postService(param,"/member/logonProccess.do");
