...
<%@ taglib uri="http://www.springframework.org/tags" prefix="spring"%>
	        ...
	        <div class="row">
	            <div class="col-md-8">
	                <div class="standard-box">
                    	...
                    	<input type="hidden" name="MENU_CD" id="MENU_CD" value="<c:choose><c:when test="${LIST_VIEW.MENU_CD eq null}">${MENU_CD}</c:when><c:otherwise>${LIST_VIEW.MENU_CD}</c:otherwise></c:choose>">
                    	...
                    	<input type="hidden" name="BOARD_TYPE_CD" id="BOARD_TYPE_CD" value="USER">
	                        ...
	                        <div class="form-group has-feedback">
	                            ...
	                            <div class="col-sm-9">
	                                <input type="text" class="form-control" id="TITLE" name="TITLE" placeholder="제목" value="${LIST_VIEW.TITLE}">
	                            </div>
	                        </div>
							 ...
							 <div class="form-group">
	                            ...
	                            <div class="col-sm-9">
	                                <textarea class="form-control" id="CONTENT_DESC" name="CONTENT_DESC" placeholder="바르고 고은말..." rows="13">${LIST_VIEW.CONTENT_DESC}</textarea>
	                            </div>
	                        </div>
					        ...
					        <div class="form-group has-feedback">
	                            ...
	                            <div class="col-sm-9">
	                                <input type="text" class="form-control" id="USER_NM" name="USER_NM" placeholder="작성자" value="${LIST_VIEW.USER_NM}">
	                                <input type="hidden" id="UPDATE_ID" name="UPDATE_ID" placeholder="작성자" value="${LIST_VIEW.UPDATE_ID}">
	                            </div>
	                        </div>
	...
	$(function()
	{
		...
		if(lv_commentYn =="N")
		{
			$("#COMMENT_YN").val("${LIST_VIEW.COMMENT_YN}").prop("selected", true);
		}
	});
